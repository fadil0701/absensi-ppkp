...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-building me-2"></i>Tambah Unit</h2>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('satpelkes.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Kode Unit <span class="text-danger">*</span></label>
                        <input type="text" name="kode_satpelkes" class="form-control @error('kode_satpelkes') is-invalid @enderror" value="{{ old('kode_satpelkes') }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_satpelkes" class="form-control @error('nama_satpelkes') is-invalid @enderror" value="{{ old('nama_satpelkes') }}" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.00000001" name="latitude" class="form-control @error('latitude') is-invalid @enderror" value="{{ old('latitude') }}" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.00000001" name="longitude" class="form-control @error('longitude') is-invalid @enderror" value="{{ old('longitude') }}" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name="radius_absensi" class="form-control @error('radius_absensi') is-invalid @enderror" value="{{ old('radius_absensi', 100) }}" min="10" required>
